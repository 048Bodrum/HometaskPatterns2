...
public class AutoTest {
    ...
    void shouldGetErrorIfBlockedUser() {
        ...
        $("button.button").click();
        $("[data-test-id='error-notification'] .notification__content").shouldHave(Condition.text("Ошибка! Пользователь забокирован"), Duration.ofSeconds(15)).shouldBe((Condition.visible));
    }
